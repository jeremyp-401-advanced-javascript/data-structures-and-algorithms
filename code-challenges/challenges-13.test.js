...
const fixTheTypo = () => {
  // Alright... now I'm kinda onboard with Cheerio.
  // That first one though... ugh... I over thought it. ¯\_(ツ)_/¯
  $('.pear').text('Pear');
};
